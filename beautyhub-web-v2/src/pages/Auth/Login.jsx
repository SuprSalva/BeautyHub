...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] rounded-full bg-cyan-400/20 blur-[120px] pointer-events-none"></div>
      ...
      <div className="bg-white/80 backdrop-blur-xl border border-white rounded-3xl shadow-[0_8px_40px_rgba(0,0,0,0.04)] w-full max-w-[420px] p-10 text-center relative z-10 animate-fade-in-up">
        ...
        <div className="flex justify-center mb-6">
          <img src="/favicon.svg" alt="BeautyHub Logo" className="w-14 h-14 rounded-2xl shadow-lg shadow-blue-500/20" />
        </div>

        <h1 className="text-3xl font-black tracking-tight text-slate-800 mb-2">Beauty<span className="text-blue-500">Hub</span></h1>
