...
const Inicio = () => {
  ...
  const stats = reports ? [
    { title: 'Ingresos de Hoy', value: `$${reports.todayRevenue}`, info: 'Suma de todas las transacciones de ingreso (Caja) registradas el día de hoy.', icon: <DollarSign size={24} />, color: 'var(--success)' },
    { title: 'Citas de Hoy', value: reports.todayAppointments, info: 'Total de citas agendadas cuya hora de inicio es durante el día de hoy.', icon: <Calendar size={24} />, color: 'var(--brand-primary)' },
    { title: 'Ingresos (7 días)', value: `$${reports.weekRevenue}`, info: 'Suma de todas las transacciones de ingreso (Caja) en los últimos 7 días.', icon: <TrendingUp size={24} />, color: 'var(--brand-secondary)' },
    { title: 'Total Clientes', value: reports.totalClients, info: 'Número total de personas registradas con el rol de Cliente en tu estética.', icon: <Users size={24} />, color: 'var(--text-main)' },
  ] : [];
              ...
              <div key={i} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm relative overflow-hidden group hover:border-blue-300 transition-colors">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="custom-tooltip-container text-slate-400 hover:text-slate-600 cursor-help">
                      <Info size={14} />
                      <span className="custom-tooltip-text">{stat.info}</span>
                    </div>
                  </div>
                ...
                <div className="absolute -bottom-4 -right-4 opacity-[0.03] transform group-hover:scale-110 transition-transform duration-500 pointer-events-none" style={{ color: stat.color }}>
